...
var TABS = [
    ...
    { id: "orders", label: "سفارش‌ها", icon: "📦", when: function () { return Boolean(state.currentSite) && ["owner", "admin"].includes(siteRole()); } },
...
SCREENS.fields = function fields() {
    return __awaiter(this, void 0, void 0, function () {
        var site, isOperator, isSiteManager, editable, data, _a, list, preset;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    skeleton(4);
                    isOperator = can("fields.manage");
                    isSiteManager = hasFeature("site_control") && ["owner", "admin"].includes(siteRole());
                    editable = isOperator || isSiteManager;
                    if (!isOperator) return [3 /*break*/, 2];
                ...
                case 4:
                    ...
                    wireFieldControls(site.id, list, function () { return go("fields"); }, { operator: isOperator });
                    preset = $("#fieldPreset");
                    if (preset) {
                        preset.onclick = function () { return modal({
                            title: "پیشنهاد جارچی",
                            ...
                            onSubmit: function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, nativeApi("/fields/".concat(encodeURIComponent(site.id), "/preset"), {
                                                method: "POST", body: JSON.stringify({ preset: "jarchi_recommended" }),
                                            })];
                                        case 1:
                                            result = _b.sent();
                                            toast("".concat(n(((_a = result.enabled) === null || _a === void 0 ? void 0 : _a.length) || 0), " \u0641\u06CC\u0644\u062F \u0631\u0648\u0634\u0646 \u0634\u062F"));
                                            return [4 /*yield*/, go("fields")];
                                        case 2:
                                            _b.sent();
                                            return [2 /*return*/];
                                    }
...
function wireFieldControls(siteId, list, refresh, _a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.operator, operator = _c === void 0 ? true : _c;
    /*
     ...
     */
    var writeField = function (key, patch) { return (operator
        ? adminApi("/clients/".concat(encodeURIComponent(siteId), "/fields/").concat(encodeURIComponent(key)), {
            method: "PATCH", body: JSON.stringify(patch),
        })
        : nativeApi("/fields/".concat(encodeURIComponent(siteId), "/").concat(encodeURIComponent(key)), {
            method: "PATCH", body: JSON.stringify(patch),
        })); };
        ...
        input.onchange = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, writeField(input.dataset.fieldKey, { platforms: (_a = {}, _a[input.dataset.fieldPlatform] = input.checked, _a) })];
                    case 2:
                        _b.sent();
                        toast("بروزرسانی شد");
                        return [3 /*break*/, 5];
        ...
        input.onchange = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, writeField(input.dataset.fieldHidden, { hidden: input.checked })];
                    case 2:
                        _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, writeField(button.dataset.fieldLabel, { label_override: label || null })];
                        case 1:
                            _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (operator
                                ? adminApi("/clients/".concat(encodeURIComponent(siteId), "/fields/reorder"), {
                                    method: "POST", body: JSON.stringify({ order: order }),
                                })
                                : nativeApi("/fields/".concat(encodeURIComponent(siteId), "/reorder"), {
                                    method: "POST", body: JSON.stringify({ order: order }),
                                }))];
                    case 2:
                        _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    result = _b.sent();
                    status_1 = (_a = result === null || result === void 0 ? void 0 : result.job) === null || _a === void 0 ? void 0 : _a.status;
                    if (!["succeeded", "failed", "cancelled"].includes(status_1)) return [3 /*break*/, 5];
                    toast(status_1 === "succeeded" ? "کار هوش مصنوعی انجام شد" : "اجرای هوش مصنوعی پایان یافت", status_1 === "succeeded" ? "ok" : "error");
...
var orderStatusLabel = function (status) { return ORDER_STATUS_LABELS[String(status || "")] || String(status || "—"); };
...
function orderMoney(amount, currency) {
    ...
    if (!Number.isFinite(value))
        return "—";
    var suffix = { IRT: "تومان", TOMAN: "تومان", IRR: "ریال" }[String(currency || "").toUpperCase()] || currency || "";
    return "".concat(value.toLocaleString("fa-IR", { maximumFractionDigits: 0 })).concat(suffix ? " ".concat(suffix) : "");
}
function orderRow(order) {
    var _a;
    var tone = (_a = ORDER_STATUS_TONE[order.status]) !== null && _a !== void 0 ? _a : "";
    return "<article class=\"record\" data-order=\"".concat(esc(String(order.order_id)), "\" role=\"button\" tabindex=\"0\">\n    <div>\n      <div class=\"record-main\">\n        <div>\n          <div class=\"record-title\">#").concat(esc(order.order_number || String(order.order_id)), "</div>\n          <div class=\"record-meta\">\n            <span>").concat(esc(order.customer_name || "مشتری مهمان"), "</span>\n            <span>").concat(esc(ago(order.created_at)), "</span>\n          </div>\n        </div>\n        <span class=\"chip ").concat(tone, "\">").concat(esc(orderStatusLabel(order.status)), "</span>\n      </div>\n      <div class=\"record-meta\"><strong>").concat(esc(orderMoney(order.total, order.currency)), "</strong></div>\n    </div>\n  </article>");
}
SCREENS.orders = function orders() {
    return __awaiter(this, void 0, void 0, function () {
        var site, filter, page, search, query, data, error_15, list, statuses, searchInput, prev, next;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    site = state.currentSite;
                    ...
                    page = Math.max(1, Number(state.orderPage || 1));
                    search = String(state.orderSearch || "");
                    query = new URLSearchParams({ page: String(page), per_page: "20" });
                    if (filter)
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, nativeApi("/sites/".concat(encodeURIComponent(site.id), "/orders?").concat(query))];
                case 2:
                    data = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    error_15 = _a.sent();
                    $("#content").innerHTML = emptyState("📦", "سفارش‌ها بارگذاری نشد", error_15.message);
                    return [2 /*return*/];
                case 4:
                    list = data.orders || [];
                    statuses = data.statuses || Object.keys(ORDER_STATUS_LABELS);
                    $("#content").innerHTML = "\n    <div class=\"section-head\">\n      <div>\n        <span class=\"eyebrow\">".concat(esc(site.name || site.id), "</span>\n        <h2>\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627\u06CC \u0648\u0648\u06A9\u0627\u0645\u0631\u0633</h2>\n        <p class=\"muted small\">").concat(n(data.total || 0), " \u0633\u0641\u0627\u0631\u0634</p>\n      </div>\n      <button class=\"btn ghost\" id=\"orderSettings\">\u062A\u0646\u0638\u06CC\u0645 \u0627\u0639\u0644\u0627\u0646</button>\n    </div>\n\n    <div class=\"subtabs\" role=\"tablist\">\n      ").concat(__spreadArray([["", "همه"]], __read(statuses.map(function (value) { return [value, orderStatusLabel(value)]; })), false).map(function (_a) {
                        var _b = __read(_a, 2), value = _b[0], label = _b[1];
                        return "<button role=\"tab\" data-order-filter=\"".concat(esc(value), "\" aria-selected=\"").concat(filter === value, "\">").concat(esc(label), "</button>");
                    })
                        .join(""), "\n    </div>\n\n    <div class=\"card\" style=\"margin-bottom:var(--space-3)\">\n      <label class=\"small\" for=\"orderSearch\">\u062C\u0633\u062A\u062C\u0648 \u0628\u0627 \u0634\u0645\u0627\u0631\u0647\u0654 \u0633\u0641\u0627\u0631\u0634 \u06CC\u0627 \u0646\u0627\u0645 \u0645\u0634\u062A\u0631\u06CC</label>\n      <input id=\"orderSearch\" type=\"search\" value=\"").concat(esc(search), "\" placeholder=\"\u0645\u062B\u0644\u0627\u064B 12548\" />\n    </div>\n\n    ").concat(list.length ? list.map(orderRow).join("") : emptyState("📦", "سفارشی در این وضعیت نیست", "سفارش‌ها پس از ثبت در ووکامرس این‌جا فهرست می‌شوند."), "\n\n    ").concat(data.pages > 1 ? "<div class=\"pager\">\n      <button class=\"btn ghost\" id=\"orderPrev\" ".concat(page <= 1 ? "disabled" : "", ">\u0642\u0628\u0644\u06CC</button>\n      <span class=\"small\">\u0635\u0641\u062D\u0647\u0654 ").concat(n(page), " \u0627\u0632 ").concat(n(data.pages), "</span>\n      <button class=\"btn ghost\" id=\"orderNext\" ").concat(page >= data.pages ? "disabled" : "", ">\u0628\u0639\u062F\u06CC</button>\n    </div>") : "");
                    $$("[data-order-filter]").forEach(function (button) {
                        button.onclick = function () {
                    ...
                    $$("[data-order]").forEach(function (card) {
                        var open = function () { return openOrder(site.id, card.dataset.order); };
                        card.onclick = open;
                        card.onkeydown = function (event) { if (event.key === "Enter" || event.key === " ") {
                            event.preventDefault();
                            open();
                        } };
                    });
                    searchInput = $("#orderSearch");
                    if (searchInput) {
                    ...
                    prev = $("#orderPrev");
                    if (prev)
                        prev.onclick = function () { state.orderPage = page - 1; go("orders"); };
                    next = $("#orderNext");
                    if (next)
                        next.onclick = function () { state.orderPage = page + 1; go("orders"); };
                    $("#orderSettings").onclick = function () { return orderSettingsModal(site.id); };
                    return [2 /*return*/];
            }
        });
    });
...
function openOrder(siteId, orderId) {
    return __awaiter(this, void 0, void 0, function () {
        var data, error_16, order, detail, items, statuses, line;
        var _this = this;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, nativeApi("/sites/".concat(encodeURIComponent(siteId), "/orders/").concat(encodeURIComponent(orderId)))];
                case 1:
                    data = _b.sent();
                    return [3 /*break*/, 3];
                case 2:
                ...
                case 3:
                    ...
                    statuses = data.statuses || Object.keys(ORDER_STATUS_LABELS);
                    line = function (label, value) { return (value ? "<dt>".concat(esc(label), "</dt><dd>").concat(esc(value), "</dd>") : ""); };
                    modal({
                        title: "\u0633\u0641\u0627\u0631\u0634 #".concat(order.order_number || order.order_id),
                        lead: data.source === "snapshot"
                            ...
                            : "",
                        body: "\n      <div class=\"chips\" style=\"margin-bottom:var(--space-3)\">\n        <span class=\"chip ".concat((_a = ORDER_STATUS_TONE[order.status]) !== null && _a !== void 0 ? _a : "", "\">").concat(esc(orderStatusLabel(order.status)), "</span>\n        <span class=\"chip\">").concat(esc(orderMoney(order.total, order.currency)), "</span>\n      </div>\n\n      <dl class=\"kv\">\n        ").concat(line("مشتری", order.customer_name), "\n        ").concat(line("تلفن", order.customer_phone), "\n        ").concat(line("ایمیل", order.customer_email), "\n        ").concat(line("پرداخت", order.payment_method), "\n        ").concat(line("وضعیت پرداخت", detail.payment_status), "\n        ").concat(line("ثبت", ago(order.created_at)), "\n        ").concat(line("آدرس صورتحساب", detail.billing_address), "\n        ").concat(line("آدرس ارسال", detail.shipping_address), "\n        ").concat(line("یادداشت مشتری", detail.customer_note), "\n      </dl>\n\n      ").concat(items.length ? "<h4 style=\"margin-top:var(--space-3)\">\u06A9\u0627\u0644\u0627\u0647\u0627</h4>\n        <ul class=\"plain\">".concat(items.map(function (item) { return "\n          <li>".concat(esc(item.name), " \u00D7 ").concat(n(item.quantity), "\n            <span class=\"muted small\">").concat(esc(orderMoney(item.total, order.currency)), "</span></li>"); }).join(""), "</ul>") : "", "\n\n      <dl class=\"kv\" style=\"margin-top:var(--space-3)\">\n        ").concat(line("جمع اقلام", detail.subtotal === null || detail.subtotal === undefined ? "" : orderMoney(detail.subtotal, order.currency)), "\n        ").concat(line("تخفیف", detail.discount ? orderMoney(detail.discount, order.currency) : ""), "\n        ").concat(line("ارسال", detail.shipping_total === null || detail.shipping_total === undefined ? "" : orderMoney(detail.shipping_total, order.currency)), "\n      </dl>\n\n      <h4 style=\"margin-top:var(--space-3)\">\u062A\u063A\u06CC\u06CC\u0631 \u0648\u0636\u0639\u06CC\u062A</h4>\n      <p class=\"muted small\">\u0648\u0636\u0639\u06CC\u062A \u0645\u0633\u062A\u0642\u06CC\u0645\u0627\u064B \u062F\u0631 \u0648\u0648\u06A9\u0627\u0645\u0631\u0633 \u062A\u063A\u06CC\u06CC\u0631 \u0645\u06CC\u200C\u06A9\u0646\u062F. \u062A\u0627 \u0648\u0642\u062A\u06CC \u0648\u0631\u062F\u067E\u0631\u0633 \u062A\u0623\u06CC\u06CC\u062F \u0646\u06A9\u0646\u062F\u060C \u0686\u06CC\u0632\u06CC \u0639\u0648\u0636 \u0646\u0645\u06CC\u200C\u0634\u0648\u062F.</p>\n      <select id=\"orderStatus\">\n        ").concat(statuses.map(function (value) { return "<option value=\"".concat(esc(value), "\" ").concat(value === order.status ? "selected" : "", ">").concat(esc(orderStatusLabel(value)), "</option>"); }).join(""), "\n      </select>"),
                        ...
                        onSubmit: function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        wanted = ((_a = $("#orderStatus")) === null || _a === void 0 ? void 0 : _a.value) || order.status;
                                        if (wanted === order.status)
                                            return [2 /*return*/];
                                        return [4 /*yield*/, nativeApi("/sites/".concat(encodeURIComponent(siteId), "/orders/").concat(encodeURIComponent(orderId), "/status"), { method: "PATCH", body: JSON.stringify({ status: wanted }) })];
                                    case 1:
                                        result = _b.sent();
                                        // The confirmed status, which WooCommerce may have adjusted.
                                        toast(result.adjusted
                                            ? "\u0648\u0648\u06A9\u0627\u0645\u0631\u0633 \u0648\u0636\u0639\u06CC\u062A \u0631\u0627 \u00AB".concat(orderStatusLabel(result.status), "\u00BB \u062B\u0628\u062A \u06A9\u0631\u062F")
                                            : "\u0648\u0636\u0639\u06CC\u062A \u0628\u0647 \u00AB".concat(orderStatusLabel(result.status), "\u00BB \u062A\u063A\u06CC\u06CC\u0631 \u06A9\u0631\u062F"));
                                        return [4 /*yield*/, go("orders")];
                                    case 2:
                                        _b.sent();
                                        return [2 /*return*/];
                                }
...
function orderSettingsModal(siteId) {
    return __awaiter(this, void 0, void 0, function () {
        var data, error_17, settings, catalog, groups, byGroup, catalog_1, catalog_1_1, field;
        var e_3, _a;
        var _this = this;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, nativeApi("/sites/".concat(encodeURIComponent(siteId), "/order-settings"))];
                case 1:
                    data = _c.sent();
                    return [3 /*break*/, 3];
                case 2:
                ...
                case 3:
                    ...
                    byGroup = {};
                    try {
                        for (catalog_1 = __values(catalog), catalog_1_1 = catalog_1.next(); !catalog_1_1.done; catalog_1_1 = catalog_1.next()) {
                            field = catalog_1_1.value;
                            (byGroup[_b = field.group] || (byGroup[_b] = [])).push(field);
                        }
                    }
                    ...
                    modal({
                        ...
                        body: "\n      <label class=\"check\">\n        <span>\u0627\u0631\u0633\u0627\u0644 \u0627\u0639\u0644\u0627\u0646 \u0633\u0641\u0627\u0631\u0634</span>\n        <span class=\"switch\">\n          <input type=\"checkbox\" id=\"orderNotify\" ".concat(settings.notify_enabled ? "checked" : "", ">\n          <span class=\"track\"></span>\n        </span>\n      </label>\n\n      ").concat(Object.entries(byGroup).map(function (_a) {
                            var _b = __read(_a, 2), group = _b[0], fields = _b[1];
                            return "\n        <h4 style=\"margin-top:var(--space-3)\">".concat(esc(groups[group] || group), "</h4>\n        ").concat(fields.map(function (field) { return "\n          <label class=\"check\">\n            <span>".concat(esc(field.label)).concat(field.sensitive ? ' <span class="chip small">اطلاعات شخصی</span>' : "", "</span>\n            <span class=\"switch\">\n              <input type=\"checkbox\" data-order-field=\"").concat(esc(field.key), "\" ").concat(field.enabled ? "checked" : "", ">\n              <span class=\"track\"></span>\n            </span>\n          </label>"); }).join(""));
                        }).join("")),
                        confirm: "ذخیره",
                        onSubmit: function () { return __awaiter(_this, void 0, void 0, function () {
                            var fields;
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        fields = {};
                                        $$("[data-order-field]").forEach(function (input) { fields[input.dataset.orderField] = input.checked; });
                                        return [4 /*yield*/, nativeApi("/sites/".concat(encodeURIComponent(siteId), "/order-settings"), {
                                                method: "PATCH",
                                                body: JSON.stringify({ notify_enabled: ((_a = $("#orderNotify")) === null || _a === void 0 ? void 0 : _a.checked) !== false, fields: fields }),
                                            })];
                                    case 1:
                                        _b.sent();
                                        toast("ذخیره شد");
...
function userDetailModal(userId) {
    return __awaiter(this, void 0, void 0, function () {
        var result, user_1, identities, subs, access, body, error_20;
        var _this = this;
        var _a, _b, _c, _d;
