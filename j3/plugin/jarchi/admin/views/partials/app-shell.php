		...
		<?php else : ?>
			<div class="jarchi-nav__group<?php echo $active ? ' is-open is-parent-active' : ''; ?><?php echo $depth > 0 ? ' is-subgroup' : ''; ?>">
				...
				>
					...
					<?php endif; ?>
					<span class="jarchi-nav__label"><?php echo esc_html( $label ); ?></span>
					<?php if ( isset( $node['badge'] ) ) : ?>
						<span class="jarchi-nav__count" aria-label="<?php echo esc_attr( sprintf( __( '%d تیکت باز', 'wp-event-publisher' ), (int) $node['badge'] ) ); ?>"><?php echo esc_html( (string) (int) $node['badge'] ); ?></span>
					<?php endif; ?>
