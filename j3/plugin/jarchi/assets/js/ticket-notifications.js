(function () {
    ...
    const paintBadgeSet = (selector, count) => {
    ...
    const setNotificationBadges = (count) => paintBadgeSet('[data-jarchi-notification-badge]', count);
    const setTicketBadges = (count) => paintBadgeSet('[data-jarchi-ticket-badge]', count);
    ...
    const poll = async (notify = false) => {
        try {
            ...
            setNotificationBadges(data.unread);
            setTicketBadges(data.ticket_unread);
