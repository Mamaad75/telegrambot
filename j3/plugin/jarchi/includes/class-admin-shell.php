...
class AdminShell {
	...
	public function items(): array {
		...
		$open_ticket_count = wpep()->tickets()->open_ticket_count();

		$tickets = array(
			'id'       => 'tickets-group',
			'label'    => __( 'تیکت‌ها', 'wp-event-publisher' ),
			'badge'    => $open_ticket_count,
			'icon'     => 'sos',
			...
			'children' => array(
				...
				array(
					'id'       => 'tickets-support-management',
					'label'    => __( 'مدیریت پشتیبانی', 'wp-event-publisher' ),
					'url'      => $admin( 'wp-event-publisher-ticket-agents' ),
					'icon'     => 'groups',
					'children' => array(
						array( 'id' => 'tickets-agents', 'label' => __( 'پشتیبان‌ها', 'wp-event-publisher' ), 'url' => $admin( 'wp-event-publisher-ticket-agents' ), 'icon' => 'groups' ),
						array( 'id' => 'tickets-departments', 'label' => __( 'دپارتمان‌ها', 'wp-event-publisher' ), 'url' => $admin( Tickets::PAGE_DEPTS ), 'icon' => 'networking' ),
				...
				array(
					'id'       => 'tickets-settings-group',
					'label'    => __( 'تنظیمات تیکت', 'wp-event-publisher' ),
					'url'      => $admin( Tickets::PAGE_UI ),
					'icon'     => 'admin-generic',
					'children' => array(
						...
						array( 'id' => 'tickets-bot', 'label' => __( 'ربات و Mini App', 'wp-event-publisher' ), 'url' => $admin( Tickets::PAGE_BOT ), 'icon' => 'format-chat' ),
						array( 'id' => 'tickets-advanced', 'label' => __( 'پیشرفته', 'wp-event-publisher' ), 'url' => $admin( Tickets::PAGE_ADVANCED ), 'icon' => 'admin-tools' ),
					),
				),
				array(
					'id'       => 'tickets-maintenance-group',
					'label'    => __( 'اتوماسیون و نگهداری', 'wp-event-publisher' ),
					'url'      => $admin( TicketAutomations::PAGE ),
					'icon'     => 'update',
					'children' => array(
