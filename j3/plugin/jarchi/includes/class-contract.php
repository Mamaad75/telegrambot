...
class Contract {
	...
	private function advertisement( Event $event, array $flat, array $post_block, array $media ): array {
		...
		$fields = array(
			...
			'contact_phone' => $this->scalar( $flat['contact_phone'] ?? '' ),
			'contact_phone_platforms' => isset( $flat['contact_phone_platforms'] ) && is_array( $flat['contact_phone_platforms'] ) ? $flat['contact_phone_platforms'] : array(),
	...
	private function author_block( array $flat ): array {
		return array(
			...
			'phone' => isset( $flat['contact_phone'] ) ? (string) $flat['contact_phone'] : '',
		);
	}
	...
	private function buttons_block( array $flat ): array {
		...
		$contact_phone_available = '' !== trim( (string) ( $flat['contact_phone'] ?? '' ) );
		...
		$buttons = array(
			...
			'contact' => array(
				...
				'enabled' => ! empty( $contact['enabled'] ) && $contact_phone_available,
